...
class MainTransfurMenu extends FlxState
{
	...
	var versionGame = '0.1.0(PRE-ALPHA)';
	...
	var musicGame = 'assets/music/mainMenu.ogg';
	...
	override public function create()
	{
		...
		staticBG.loadGraphic(wayI + 'mainMenu/static.png', true, 640, 480);
		...
		shark = new FlxSprite();
		shark.loadGraphic(wayI + 'mainMenu/theShark.png', true, 640, 480);
		...
		sharkExe.loadGraphic(wayI + 'mainMenu/theSharkEXE.png', true, 640, 480);
		...
		originalGame.setFormat(wayF + 'offBitBold.ttf', 15, FlxColor.WHITE);
			...
			if (touch.justPressed)
			{
				...
				if (menuSelection == true)
				{
					...
					if (touch.overlaps(buttonSix))
					{
						...
						musicGame = 'assets/music/mainMenuSecret.ogg';
